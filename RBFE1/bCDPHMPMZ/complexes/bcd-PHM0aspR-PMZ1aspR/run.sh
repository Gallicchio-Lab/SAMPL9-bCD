#!/bin/bash
#SBATCH -J bcd-PHM0aspR-PMZ1aspR
...
cp ../../scripts/nodefile .
../../scripts/runopenmm /home/users/egallicchio/Dropbox/devel/src/async_re-openmm/rbfe_explicit.py bcd-PHM0aspR-PMZ1aspR_asyncre.cntl
