#!/bin/bash
#SBATCH -J bcd-PHM0apsR-PMZ1apsR
...
cp ../../scripts/nodefile .
../../scripts/runopenmm /home/users/egallicchio/Dropbox/devel/src/async_re-openmm/rbfe_explicit.py bcd-PHM0apsR-PMZ1apsR_asyncre.cntl
