#!/bin/bash
#SBATCH -J bcd-PHM0appS-PMZ1appS
...
cp ../../scripts/nodefile .
../../scripts/runopenmm /home/users/egallicchio/Dropbox/devel/src/async_re-openmm/rbfe_explicit.py bcd-PHM0appS-PMZ1appS_asyncre.cntl
