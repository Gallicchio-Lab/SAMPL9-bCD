#!/bin/bash
#SBATCH -J bcd-PHM0apsS-PMZ1apsS
...
cp ../../scripts/nodefile .
../../scripts/runopenmm /home/users/egallicchio/Dropbox/devel/src/async_re-openmm/rbfe_explicit.py bcd-PHM0apsS-PMZ1apsS_asyncre.cntl
