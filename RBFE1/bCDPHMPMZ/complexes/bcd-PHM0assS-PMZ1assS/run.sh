#!/bin/bash
#SBATCH -J bcd-PHM0assS-PMZ1assS
...
cp ../../scripts/nodefile .
../../scripts/runopenmm /home/users/egallicchio/Dropbox/devel/src/async_re-openmm/rbfe_explicit.py bcd-PHM0assS-PMZ1assS_asyncre.cntl
