#!/bin/bash
#SBATCH -J bcd-PHM0aspS-PMZ1aspS
...
cp ../../scripts/nodefile .
../../scripts/runopenmm /home/users/egallicchio/Dropbox/devel/src/async_re-openmm/rbfe_explicit.py bcd-PHM0aspS-PMZ1aspS_asyncre.cntl
