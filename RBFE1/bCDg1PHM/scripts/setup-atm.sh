...
cup_atoms="44 49 54 59 64 69 74"
...
for l in `seq 0 $n` ; do
    ...
    #theta and psi orientation angles
    theta_psi_pair=${theta_psi[$l]}
    read -ra tp <<< $theta_psi_pair
    theta0="${tp[0]}"
    psi0="${tp[1]}"    
